...
if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] === false) {
    ...
    exit;
} elseif (isset($_SEssion['loggedin']) && $_SESSION['user_rol']<= 2) {
    $_SESSION["msg_type"] = $t["msg_type_dan"];
    $_SESSION["msg_text"] = $t["msg"]["msg_user_not_allowed_2"];
    header("Location: index.php");
    exit;
}
...
<div class="page-content">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class=" danger">
            ...
            echo "De momento se queda asi ;)<br><h2>Seguro que quieres borrar esta receta?</h2>";
            echo $receta_name;
